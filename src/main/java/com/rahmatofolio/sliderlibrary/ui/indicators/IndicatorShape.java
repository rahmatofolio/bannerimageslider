 ...
 */
public class IndicatorShape extends AppCompatImageView {
    ...
    public IndicatorShape(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public IndicatorShape(Context context, AttributeSet attrs, int defStyleAttr) {
